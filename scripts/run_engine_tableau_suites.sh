...
TABLEAU_SUITES=${TABLEAU_SUITES:-mysql_compat_tableau_metadata.yaml mysql_compat_tableau_worksheets.yaml mysql_compat_tableau_custom_sql.yaml mysql_compat_tableau_extract.yaml}
