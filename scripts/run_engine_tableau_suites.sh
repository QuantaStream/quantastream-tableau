...
TABLEAU_SUITES=${TABLEAU_SUITES:-mysql_compat_tableau_connect.yaml mysql_compat_tableau_superstore_metadata.yaml mysql_compat_tableau_superstore_worksheets.yaml}
